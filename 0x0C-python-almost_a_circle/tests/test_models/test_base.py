#!/usr/bin/python3
'''Define a Module for Base unit tests'''
import unittest
...
class TestBase(unittest.TestCase):
    '''Defining the Tests for the Base class.'''

    def setUp(self):
        '''Initializes necessary variables before each test.'''
    ...
    def test_A_nb_objects_private(self):
        '''Verifies if nb_objects is a private class attribute.'''
        self.assertTrue(hasattr(Base, "_Base__nb_objects"))

    def test_B_nb_objects_initialized(self):
        '''Checks if nb_objects initializes to zero.'''
    ...
    def test_D_constructor(self):
        '''Ensures the constructor signature.'''
    ...
    def test_D_constructor_args_2(self):
        '''Checks constructor signature with 2 non-self args.'''
        with self.assertRaises(TypeError) as e:
    ...
    def test_E_consecutive_ids(self):
        '''Verifies consecutive IDs.'''
        b1 = Base()
        b2 = Base()
        self.assertEqual(b1.id + 1, b2.id)

    def test_F_id_synced(self):
        '''Ensures synchronization between class and instance id.'''
        b = Base()
        self.assertEqual(getattr(Base, "_Base__nb_objects"), b.id)

    def test_F_id_synced_more(self):
        '''Ensures synchronization between class and instance id with multiple instances.'''
        b = Base()
        b = Base("Foo")
        b = Base(98)
        b = Base()
